...
import com.example.android.sunshine.databinding.ActivityDetailBindingPortImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
    ...
    if(localizedLayoutId > 0) {
      ...
      switch(localizedLayoutId) {
        case  LAYOUT_ACTIVITYDETAIL: {
          ...
          if ("layout-port/activity_detail_0".equals(tag)) {
            return new ActivityDetailBindingPortImpl(component, view);
          }
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      ...
      sKeys.put("layout-port/activity_detail_0", com.example.android.sunshine.R.layout.activity_detail);
